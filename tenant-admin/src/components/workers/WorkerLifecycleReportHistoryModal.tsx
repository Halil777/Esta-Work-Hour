...
import { AlertCircle, Download, History, Mail, RefreshCw, Send } from 'lucide-react'
...
export function WorkerLifecycleReportHistoryModal({ onClose, onChanged }: WorkerLifecycleReportHistoryModalProps) {
  ...
  return (
    <AppModal
      title={<span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}><History size={17} /> {t.lifecycleHistory.title}</span>}
      onClose={onClose}
      maxWidth={920}
      footer={
