          ...
          {!result ? (
            <>
              ...
              <p style={{ fontSize: 11, color: "var(--text-muted)", marginBottom: 12, lineHeight: 1.6 }}>
                <code>Sicil No · İnsan Adı · Görev · EKIP · Mesai Sistemi</code><br/>
                <span style={{ opacity: 0.7 }}>ýa-da: workerId · name · profession · brigadeName</span>
              </p>
              {error && (
                <div style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 12px", background: "var(--danger-light)", borderRadius: 6, marginBottom: 10, color: "var(--danger)", fontSize: 13 }}>
                  <AlertCircle size={14} /> {error}
            ...
            <div style={{ textAlign: "center", padding: "16px 0" }}>
              ...
              <p style={{ fontWeight: 600 }}>{result.imported} täze işçi goşuldy</p>
              {(result.updated ?? 0) > 0 && <p style={{ fontSize: 12, color: "var(--text-muted)" }}>{result.updated} işçi täzelendi</p>}
            </div>
          )}
        </div>
        <div className="modal-footer">
