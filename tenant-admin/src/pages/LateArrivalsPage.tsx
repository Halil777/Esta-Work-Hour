...
export function LateArrivalsPage() {
  ...
  const nightSettings = data?.nightSettings ?? {
    startTime: "18:00",
    graceMinutes: 60,
  };
  ...
  const renderRow = (w: any) => (
    <tr key={w.workerEntityId}>
      ...
      <td>
        ...
        {w.isStaff && (
          <span
            className="badge badge--dot badge--info"
        ...
        <button
          ...
          onClick={() =>
            setNoteModal({
              ...
              existingNote: w.absenceNote?.note,
            })
          }
        >
